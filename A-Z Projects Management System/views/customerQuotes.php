...
<html>
    ...
    <body>
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <div class="nav-item dropdown-menu">
                                ...
                                <a class="dropdown-item active" href="customerQuotes.php">My Quotes</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h2 style="text-align: center;">My Quotations</h2>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <?php 
                    ...
                    $sql_select = "SELECT * FROM `quotes` WHERE userId=" . $_SESSION['userId'] . " AND status='SENT TO CLIENT'";
                                ...
                                <div class="col-sm-12">
                                    <div class="card-deck card-columns">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <b>Description: </b><br><?php echo $row['quoteDescription']; ?><br>
                                                <b>Estimated Price: </b><?php echo $row['estimatedPrice']; ?><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
